    ...
    <div class="mx-auto max-w-2xl">
        ...
        <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Welcome to <span
                    class="bg-gradient-to-r from-sky-400 to-emerald-600 bg-clip-text text-transparent">Eric
                    Blog</span></h1>
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="/blog"
                    ...
                    started</a>
                <a href="/about" class="text-sm font-semibold leading-6 text-gray-900">Learn more
