    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                <span class="sr-only">Eric Blog</span>
                <h1 class="text-2xl font-normal"><span class="font-bold">Eric</span> Blog</h1>
            </a>
        </div>
            ...
            @if (Auth::check())
                ...
                <a href="{{ route('dashboard') }}" class="relative text-sm font-semibold leading-6 text-gray-900">Dashboard <span
                    ...
                    @if (Auth::user()->unreadNotifications->count() > 0)
                        <span
                            class="absolute -end-2 top-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-red-500 dark:border-gray-800"></span>
                    @endif
                </a>
            @else
