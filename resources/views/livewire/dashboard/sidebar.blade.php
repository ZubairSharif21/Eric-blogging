<div x-data="{ mobileExpanded: false }" x-on:mobile-sidebar-show.window="mobileExpanded = !mobileExpanded"
    x-on:mobile-sidebar-hide.window="mobileExpanded = false"
    :class="mobileExpanded ? 'h-screen w-full bg-[rgba(0,0,0,0.5)]' : ''"
    class="fixed left-0 top-0 z-[39] transition-[background_500ms_ease]">

    <aside id="default-sidebar" x-data="{ isExpanded: $wire.isExpanded }" x-on:toggle-sidebar.window="isExpanded = !isExpanded"
        :class="{
            'sm:w-64': isExpanded,
            'sm:w-16': !isExpanded,
            'translate-x-0': mobileExpanded,
            '-translate-x-full': !mobileExpanded
        }"
        x-cloak
        class="absolute left-0 top-0 z-40 h-screen pt-14 [transition:width_500ms_ease,_transform_500ms_ease] sm:translate-x-0 lg:pt-16"
        aria-label="Sidenav">
        <div
            ...
            <div class="flex justify-center">
                <h1 class="inline-block whitespace-nowrap text-2xl font-semibold dark:text-white sm:hidden">
                    Blog</h1>
            </div>
            <div class="mb-6 mt-2 flex gap-1 pl-2 sm:hidden">
            ...
            <ul class="space-y-2">
                {{-- Side Menu Overview --}}
                <li class="{{ $isDashboard ? 'bg-gray-200 rounded-lg' : '' }}">
                    <a href="/dashboard" wire:navigate
                        ...
                        <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                            class="ml-3 flex-1 whitespace-nowrap text-left">Overview</span>
                    </a>
                </li>

                @can('create post')
                    {{-- Side Menu Post --}}
                    <li class="{{ $isPost ? 'bg-gray-200 rounded-lg' : '' }}">
                        <a href="/dashboard/posts" wire:navigate
                            ...
                            <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                                class="ml-3 flex-1 whitespace-nowrap text-left">Posts</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('view category')
                    ...
                    <li class="{{ $isCategory ? 'bg-gray-200 rounded-lg' : '' }}">
                        <a href="/dashboard/categories" wire:navigate
                            ...
                            <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                                class="ml-3 flex-1 whitespace-nowrap">Categories</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('view tag')
                    {{-- Side Menu Tags --}}
                    <li class="{{ $isTag ? 'bg-gray-200 rounded-lg' : '' }}">
                        <a href="/dashboard/tags" wire:navigate
                            ...
                            <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                                class="ml-3 flex-1 whitespace-nowrap text-left">Tags</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('edit role')
                    {{-- Side Menu Users --}}
                    <li class="{{ $isUser ? 'bg-gray-200 rounded-lg' : '' }}">
                        <a href="/dashboard/users" wire:navigate
                            ...
                            <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                                class="ml-3 flex-1 whitespace-nowrap text-left">Users</span>
                        </a>
                    </li>
                @endcan
                ...
                @can('create comment')
                    {{-- Side Menu Users --}}
                    <li class="{{ $isComment ? 'bg-gray-200 rounded-lg' : '' }}">
                        <a href="/dashboard/comments" wire:navigate
                            ...
                            <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                                class="ml-3 flex-1 whitespace-nowrap text-left">Comments</span>
                        </a>
                    </li>
                @endcan

                {{-- Side Menu Notifications --}}
                <li class="{{ $isNotification ? 'bg-gray-200 rounded-lg' : '' }}">
                    <a href="/dashboard/notifications" wire:navigate
                        class="group flex w-full items-center rounded-lg p-2 text-base font-normal text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white">
                            <path fill-rule="evenodd"
                        ...
                        <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                            class="ml-3 flex-1 whitespace-nowrap text-left">Notifications</span>
                    </a>
                </li>
            </ul>
            {{-- <ul class="my-5 border-b border-t border-gray-200 py-7 dark:border-gray-700">
                <li>
                    <a href="#"
                        ...
                        <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                            class="ml-3 flex-1 whitespace-nowrap text-left">Docs</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                        ...
                        <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                            class="ml-3 flex-1 whitespace-nowrap text-left">Components</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                        ...
                        <span :class="isExpanded ? '' : 'w-0 overflow-hidden'"
                            class="ml-3 flex-1 whitespace-nowrap text-left">Help</span>
                    </a>
                </li>
            </ul> --}}
            {{-- <div
