<form x-data="{ c: {{ $c }}, other: '' }" class="mb-6" x-show="reply || editMode" x-cloak
    ...
    <div
        ...
        <textarea id="content" rows="6" wire:model="content"
            ...
            placeholder="Write a comment..." {{ Auth::check() ? '' : 'disabled' }} x-model="editMode ? c.content : other"></textarea>
    </div>
    @error('content')
