<div x-data="{
    ...
    <div x-show="showModalImage" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
        ...
        <div x-show="showModalImage" x-data x-transition:enter="transition ease-out duration-200"
            ...
            class="relative left-1/2 z-[100] my-20 flex h-[75vh] w-3/4 -translate-x-1/2 flex-col rounded-xl bg-zinc-50 py-4 sm:w-1/2">
                ...
                <form wire:submit="save" class="flex h-full">
                    ...
                    <div class='flex h-full w-full flex-col gap-4 sm:flex-row'>
                        <div class="w-full sm:w-1/2">
                            ...
                            <input id="profile_pic" wire:loading.attr="disabled" wire:model="profile_pic" class="hidden"
                                type="file">
                            @if (!$profile_pic)
                                <div
                                    ...
                                    <label for="profile_pic"
                                        ...
                                        <span wire:loading.remove wire:target="profile_pic">Select Image</span>
                                    </label>
                                </div>
                        ...
                        <div class="flex w-full flex-col justify-between sm:w-1/2">
                            <div>
                                @if ($profile_pic)
                                    <label for="profile_pic"
                            ...
                            <div>
                                ...
                                <button type="submit"
                                    ...
                                    wire:target="profile_pic" wire:loading.class="hover:cursor-not-allowed"
                                    wire:loading.attr="disabled" x-on:click="showLoading = true"
                                    ...
                                    <div role="status" x-show="showLoading" class="flex items-center gap-2">
                                        <svg aria-hidden="true"
                                            class="inline h-3 w-3 animate-spin fill-blue-600 text-white dark:text-gray-600"
                                            viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <span wire:loading.class="opacity-0 hidden" x-show="!showLoading"
                                        wire:target="profile_pic">Save</span>
                                </button>
                            </div>
                        </div>
                    </div>
